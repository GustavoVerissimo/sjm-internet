    ...
    return(
        <section className="flex flex-row items-center justify-center bg-(--color-background-darkblue)">
            <div className="flex flex-row items-center">
                ...
                <div className="w-[500px] h-[300px] mb-[60px]">
                    <p className="text-[20px] text-white">Com o <span className="font-black text-(--color-text-orange)">streaming by Watch</span>, além dos conteúdos exclusivos da Paramount+, você assiste canais ao vivo como Paramount, MTV, MTV Live, Nick Jr, Nickelodeon e Comedy Central, além de conteúdos gravados da Sony Channel, CNN Brasil, Universal e Xpeed by XP Investimentos.</p>
                    <p className="mt-[10px] text-[20px] max-sm:text-[18px] max-sm:ml-2 text-left text-white"> Disponiveis nos planos:</p>
