...
export default function TabsStreaming(){
    return(
        <div>
             <Tabs defaultValue="paramount" className="w-[800px] h-[400px]">    
                <TabsList className="grid w-full grid-cols-3 h-auto bg-gray-50 shadow-2xl">
                 ...
                 <TabsContent value="paramount" className="">
                    <div className=" flex flex-row justify-between bg-white rounded-2xl mb-2 shadow-2xl">
                        <div className="w-[250px] h-[200px] pl-5">
                            ...
                            <button className="w-64 max-sm:w-40 bg-(--color-button-darkblue) hover:bg-(--color-button-darkblue) text-white px-3 py-2 mt-3 rounded-3xl">Saiba Mais</button>
                        </div>
                        <Image src={BannerParamountStreaming} alt="banner da paramount" className="w-[500px] h-[300px] rounded-r-2xl"/>
                    </div>
                 </TabsContent>
                 ...
                 <TabsContent value="telecine">
                    <div className=" flex flex-row justify-between bg-white rounded-2xl mb-2 shadow-2xl">
                        ...
                        <Image src={BannerTelecineStreaming} alt="banner da telecine" className="w-[500px] h-[300px] rounded-r-2xl"/>
                    </div>
                 </TabsContent>
             </Tabs>
        </div>
