...
export default function Streamings(){
    return(
        <>
            <Header />
                <main className="h-full justify-items-center bg-(--color-background-grey)">
                    <section className="flex flex-col md:flex-row py-[30px] items-center">
                        ...
                        <div className="w-[500px] max-sm:w-[330px] h-[300px]">
                            <p className="text-[20px] max-sm:text-[17px] text-(--color-text-grey)">Com o <span className="font-black text-(--color-text-orange)">streaming by Watch</span>, além dos conteúdos exclusivos da Paramount+, você assiste canais ao vivo como Paramount, MTV, MTV Live, Nick Jr, Nickelodeon e Comedy Central, além de conteúdos gravados da Sony Channel, CNN Brasil, Universal e Xpeed by XP Investimentos.</p>
