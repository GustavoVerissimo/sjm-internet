    ...
    return(
        <div className="flex flex-row max-sm:flex-col-reverse items-center justify-between font-(--font-display-rubik)">
          <div className="p-[30px]">
            ...
            <button className="bg-(--color-button-darkblue) w-64 sm:hover:bg-(--color-button-blue) text-white px-3 py-2 rounded-3xl "><a href="#planos">Confira Nossos Planos</a></button>
          </div>
