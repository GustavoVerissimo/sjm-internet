        ...
        <section className="flex flex-col items-center justify-center bg-(--color-background-darkblue)">
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="w-[500px] max-sm:w-[330px] h-[300px] max-sm:h-[350px] mb-[60px]">
                    ...
                    <button className="mt-3 w-64 bg-white sm:hover:bg-(--color-button-blue) text-(--color-text-darkblue) px-3 py-2 rounded-3xl"><a href="/streamings">Saiba Mais</a></button>
                    <button className="mt-3 w-64 flex flex-row justify-center items-center bg-(--color-button-gren) text-white px-3 py-2 rounded-3xl"><BsWhatsapp  className="mr-1"/> <a href="https://wa.me/552131803223?text=Olá, gostaria de saber mais informações sobre os planos de fibra + streaming!">WhatsApp</a></button>
                </div>
            </div> 
        </section>
    )
